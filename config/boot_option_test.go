...
func TestAddProperty(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				opts: []Option{
					AddProperty("autowire.<github.com/cc-cheunggg/ioc-golang/test.Model>.sub.sub.sub.sub.sub", "val1"),
					AddProperty("autowire.sub.sub2.<github.com/cc-cheunggg/ioc-golang/test.Model>", "val2"),
					AddProperty("<github.com/cc-cheunggg/ioc-golang/test.Model>.autowire.sub1", "val3"),
					AddProperty("<github.com/cc-cheunggg/ioc-golang/test.Model2>", "val4"),
				},
			},
			keys: []string{"autowire.<github.com/cc-cheunggg/ioc-golang/test.Model>.sub.sub.sub.sub.sub",
				"autowire.sub.sub2.<github.com/cc-cheunggg/ioc-golang/test.Model>",
				"<github.com/cc-cheunggg/ioc-golang/test.Model>.autowire.sub1",
				"<github.com/cc-cheunggg/ioc-golang/test.Model2>"},
