...
type NormalApp struct {
	...
	ServiceImpl1 Service `normal:"github.com/cc-cheunggg/ioc-golang/test/stress/autowire.ServiceImpl1"`

	// inject main.ServiceImpl2 pointer to Service interface with proxy wrapper
	ServiceImpl2 Service `normal:"github.com/cc-cheunggg/ioc-golang/test/stress/autowire.ServiceImpl2"`
